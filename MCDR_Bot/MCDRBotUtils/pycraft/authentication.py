...
AUTH_SERVER = "https://your.yggdrasil.api/api/yggdrasil/authserver"
SESSION_SERVER = "https://your.yggdrasil.api/api/yggdrasil/sessionserver/session/minecraft"
...
class AuthenticationToken(object):
    ...
    def authenticate(self, username, password, invalidate_previous=True):
        """
    ...
    def join(self, server_id):
        ...
        res = _make_request(SESSION_SERVER, "join",
                            {"accessToken": self.access_token,
                             "selectedProfile": self.profile.to_dict()["id"],
                             "serverId": server_id})
